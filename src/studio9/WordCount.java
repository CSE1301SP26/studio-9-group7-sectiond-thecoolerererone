...
public class WordCount {
    ...
    /**
     * Constructs and returns a map of the distinct words in the specified list
     * with each word associated with its accumulated count (that is: the number
     ...
     *
     * key="to", value=2; key="be", value=2; key="or", value=1; key="not",
     * value=1;
     *
     * @param words
